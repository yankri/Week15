...
namespace MyCloset2.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccsID,Nickname,PhotoURL,Type,Color,Season,Occasion")] Accessories accessories)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccsID,Nickname,PhotoURL,Type,Color,Season,Occasion")] Accessories accessories)
        {
            if (ModelState.IsValid)
            {
